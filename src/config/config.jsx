  ...
  curveFactoryV2ABI: [
    {
      name: "BasePoolAdded",
      inputs: [
        { type: "address", name: "base_pool", indexed: false },
        { type: "address", name: "implementat", indexed: false },
      ],
      anonymous: false,
      type: "event",
    },
    {
      ...
      inputs: [
        { type: "address", name: "coin", indexed: false },
        { type: "address", name: "base_pool", indexed: false },
        { type: "uint256", name: "A", indexed: false },
        { type: "uint256", name: "fee", indexed: false },
        { type: "address", name: "deployer", indexed: false },
      ],
      anonymous: false,
      type: "event",
    },
    ...
    },
    {
      ...
      inputs: [
        ...
        { type: "address", name: "_metapool_implementation" },
        { type: "address", name: "_fee_receiver" },
      ],
      stateMutability: "nonpayable",
      type: "function",
      gas: 544334,
