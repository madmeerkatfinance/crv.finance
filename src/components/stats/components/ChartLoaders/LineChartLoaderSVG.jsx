...
const LineChartLoaderSVG = (props) => {
  return (
    <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 50" xmlns='http://www.w3.org/2000/svg' color='text' style={{ alignItems: 'center', flexShrink: '0'}} {...props}>
      <path
