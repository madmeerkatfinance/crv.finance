...
const AssetLink = ({ id, erc20address, symbol, classes }) => (
  <a key={`link-${erc20address}-${symbol}-${id}`} href={`https://cronoscan.com/token/${erc20address}`} target="_blank" rel="noopener noreferrer" className={classes.link}>{symbol}</a>
);
